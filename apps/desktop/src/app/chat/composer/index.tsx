...
export function ChatBar({
  ...
  // Fork customization: external clear-draft requests (New Chat, session resume,
  // etc.) fire `hermes:composer-clear-draft` from clearComposerDraft() in
  // store/composer.ts. Bridge it to the draft engine so the editor DOM and
  // composer state clear in lockstep with the nanostores draft.
  useEffect(() => {
