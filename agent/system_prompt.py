...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None) -> Dict[str, str]:
    ...
    if not agent.skip_context_files:
        # Prefer the per-session desktop workspace override, then configured
        # TERMINAL_CWD. When neither is set, None lets context discovery fall
        # back to the launch directory for local CLI/TUI sessions.
        #
